...
_getStatus(PhidgetChannelHandle phid, BridgePacket **bp) {
	...
	return (createBridgePacket(bp, BP_SETSTATUS, 33, "_class_version_=%u"
	  ",positionOffset=%l"
	  ",acceleration=%g"
	  ",minAcceleration=%g"
	  ",maxAcceleration=%g"
...
API_PRETURN
PhidgetBLDCMotor_setFailsafeBrakingStrength(PhidgetBLDCMotorHandle ch, double failsafeBrakingStrength) {
...
API_PRETURN
PhidgetBLDCMotor_getFailsafeBrakingStrength(PhidgetBLDCMotorHandle ch,
  double *failsafeBrakingStrength) {
