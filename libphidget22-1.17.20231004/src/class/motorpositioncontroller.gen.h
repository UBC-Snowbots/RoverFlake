...
API_PRETURN_HDR PhidgetMotorPositionController_getMinBrakingStrength(PhidgetMotorPositionControllerHandle ch, double *minBrakingStrength);
API_PRETURN_HDR PhidgetMotorPositionController_getMaxBrakingStrength(PhidgetMotorPositionControllerHandle ch, double *maxBrakingStrength);
...
API_PRETURN_HDR PhidgetMotorPositionController_getEngaged(PhidgetMotorPositionControllerHandle ch,
  int *engaged);
API_PRETURN_HDR PhidgetMotorPositionController_setFailsafeBrakingStrength(PhidgetMotorPositionControllerHandle ch, double failsafeBrakingStrength);
API_PRETURN_HDR PhidgetMotorPositionController_getFailsafeBrakingStrength(PhidgetMotorPositionControllerHandle ch, double *failsafeBrakingStrength);
API_PRETURN_HDR PhidgetMotorPositionController_setFailsafeCurrentLimit(PhidgetMotorPositionControllerHandle ch, double failsafeCurrentLimit);
API_PRETURN_HDR PhidgetMotorPositionController_getFailsafeCurrentLimit(PhidgetMotorPositionControllerHandle ch, double *failsafeCurrentLimit);
