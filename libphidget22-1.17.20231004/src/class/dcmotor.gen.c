...
API_PRETURN
PhidgetDCMotor_setFailsafeBrakingStrength(PhidgetDCMotorHandle ch, double failsafeBrakingStrength) {
...
API_PRETURN
PhidgetDCMotor_getFailsafeBrakingStrength(PhidgetDCMotorHandle ch, double *failsafeBrakingStrength) {
