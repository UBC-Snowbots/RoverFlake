...
_getStatus(PhidgetChannelHandle phid, BridgePacket **bp) {
	...
	return (createBridgePacket(bp, BP_SETSTATUS, 42, "_class_version_=%u"
	  ",positionOffset=%l"
	  ",acceleration=%g"
	  ",minAcceleration=%g"
	  ",maxAcceleration=%g"
...
API_PRETURN
PhidgetMotorPositionController_getMinBrakingStrength(PhidgetMotorPositionControllerHandle ch,
  double *minBrakingStrength) {
...
API_PRETURN
PhidgetMotorPositionController_getMaxBrakingStrength(PhidgetMotorPositionControllerHandle ch,
  double *maxBrakingStrength) {
...
API_PRETURN
PhidgetMotorPositionController_setFailsafeBrakingStrength(PhidgetMotorPositionControllerHandle ch,
  double failsafeBrakingStrength) {
...
API_PRETURN
PhidgetMotorPositionController_getFailsafeBrakingStrength(PhidgetMotorPositionControllerHandle ch,
  double *failsafeBrakingStrength) {
