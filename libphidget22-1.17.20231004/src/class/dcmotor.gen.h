...
API_PRETURN_HDR PhidgetDCMotor_setFailsafeBrakingStrength(PhidgetDCMotorHandle ch,
  double failsafeBrakingStrength);
API_PRETURN_HDR PhidgetDCMotor_getFailsafeBrakingStrength(PhidgetDCMotorHandle ch,
  double *failsafeBrakingStrength);
