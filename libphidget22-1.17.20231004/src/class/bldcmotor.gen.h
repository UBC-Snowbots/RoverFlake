...
API_PRETURN_HDR PhidgetBLDCMotor_setFailsafeBrakingStrength(PhidgetBLDCMotorHandle ch,
  double failsafeBrakingStrength);
API_PRETURN_HDR PhidgetBLDCMotor_getFailsafeBrakingStrength(PhidgetBLDCMotorHandle ch,
  double *failsafeBrakingStrength);
